#!/usr/bin/env python3
"""
Create a small test classification dataset for 1-epoch testing
"""
...
def create_test_classification_dataset():
    ...
    for split in ['train', 'valid']:
        ...
        image_files = list(source_images.glob("*.png"))[:5]
            ...
            try:
                with open(label_path, 'r') as f:
                    ...
                    if len(lines) >= 2:
                        ...
                        if len(cls_label) == 3 and '1' in cls_label:
                            ...
                            print(f"  Copied {img_path.name} to {cls_name}")
